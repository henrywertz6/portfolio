    ...
    <div className="container mx-auto px-10 pt-20 pb-20 bg-[#1E201E] text-[#ECDFCC] font-lora">
      ...
      <div className="flex justify-center">
        <a
          ...
          className="inline-flex text-[#ECDFCC] bg-[#697565] border-0 py-2 px-6 focus:outline-none hover:bg-[#6f7c6a] rounded text-lg"
        >
          Work With Me
        </a>
        <a
          href="https://github.com/henrywertz6"
          className="ml-4 inline-flex text-[#ECDFCC] bg-[#3C3D37] border-0 py-2 px-6 focus:outline-none hover:bg-[#44463f] rounded text-lg"
        >
          See My Past Work
        </a>
      </div>
